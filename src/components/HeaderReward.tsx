...
export default function HeaderReward() {
  ...
  return (
    <>
      <header>
        <h2 className="flex mt-28 m-3 gap-3 font-semibold text-[#FFCE04]">
          <span className="text-5xl font-bold">{hello}</span>
          <div className="flex text-5xl">
            <span className="flex font-bold">☕The News Rewards Room</span>
